        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <form id="" action="{{ route('form/save') }}" method="POST">
                    ...
                    <div class="form-group row">
                        <label class="col-form-label col-sm-2 text-sm-right">Company Name</label>
                        <div class="col-sm-10">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="sex" name="sex" value="{{ $datas->sex }}">
                            <div class="clearfix"></div>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="country" name="country"value="{{ $datas->country }}">
                            <div class="clearfix"></div>
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            ...
                            <textarea name="notes" class="form-control" rows="4" placeholder="Enter Notes">{{ $datas->notes }}</textarea>
                            <div class="clearfix"></div>
                        </div>
                    </div>
                    {{-- <div class="form-group row">
